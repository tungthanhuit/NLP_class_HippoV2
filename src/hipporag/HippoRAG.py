...
class HippoRAG:
    ...
    def insert_facts(self, facts: List[Tuple]) -> None:
        """Insert structured facts into the baseline fact embedding store."""
    ...
    def get_metrics_snapshot(self) -> Dict:
        ...
        return {
            ...
            "llm_budget": {
                ...
                "total_calls": self.qa_llm_calls,
                "total_prompt_tokens": self.qa_prompt_tokens,
                "total_completion_tokens": self.qa_completion_tokens,
                "total_tokens": self.qa_prompt_tokens + self.qa_completion_tokens,
            },
            "timing": {
